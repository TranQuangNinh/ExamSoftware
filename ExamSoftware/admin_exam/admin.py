...
class ResultAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        (None, {
            'fields': ('user', 'exam', 'question', 'choose_answer')
        }),
    )
...
class QuestionAdmin(ImportExportModelAdmin):
    ...
    search_fields = ['question_main', 'question_sub',
                     'subject__subject_name', 'status']
...
class BatchAdmin(ImportExportModelAdmin):
    ...
    search_fields = ['created_date', 'time_from',
                     'time_to', 'status', 'show_notifi']
    fieldsets = (
        (None, {
